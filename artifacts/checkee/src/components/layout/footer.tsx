...
export function Footer() {
  return (
    <footer className="bg-[#0B4F6C] pt-24 pb-12 border-t border-[#E5EAF0]/10">
      <div className="container px-6 md:px-12 max-w-[1400px] mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 md:gap-8 mb-20">
          <div className="md:col-span-4 space-y-8">
            ...
            <p className="text-[#D9EEF5] text-[14px] leading-relaxed max-w-sm font-normal">
            ...
            <div className="space-y-3">
              <div className="flex items-center gap-3 text-[#D9EEF5] text-[14px]">
                <Phone className="w-5 h-5 text-[#1A7EA4]" />
                <span className="font-semibold text-white">Hotline: 1900 1234</span>
              </div>
              <div className="flex items-center gap-3 text-[#D9EEF5] text-[14px]">
                <Mail className="w-5 h-5 text-[#1A7EA4]" />
                <span>hello@checkee.vn</span>
              </div>
              <div className="flex items-start gap-3 text-[#D9EEF5] text-[14px]">
                <MapPin className="w-5 h-5 text-[#1A7EA4] shrink-0 mt-0.5" />
          ...
          <div className="md:col-span-2 md:col-start-7">
            ...
            <ul className="space-y-4 text-[14px] text-[#D9EEF5]">
        ...
        <div className="pt-8 border-t border-[#D9EEF5]/20 flex flex-col md:flex-row justify-between items-center gap-4 text-[13px] text-[#D9EEF5]">
