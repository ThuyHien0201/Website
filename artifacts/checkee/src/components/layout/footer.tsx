...
export function Footer() {
  return (
    <footer className="bg-[#1557B0] pt-24 pb-12 border-t border-[#E5EAF0]/10">
      <div className="container px-6 md:px-12 max-w-[1400px] mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 md:gap-8 mb-20">
          ...
          <div className="md:col-span-2 md:col-start-7">
            ...
            <ul className="space-y-4 text-[14px] text-[#DCEEFF]">
        ...
        <div className="pt-8 border-t border-[#DCEEFF]/20 flex flex-col md:flex-row justify-between items-center gap-4 text-[13px] text-[#DCEEFF]">
