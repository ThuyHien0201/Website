...
export function Footer() {
  return (
    <footer className="bg-[#060C2A] pt-32 pb-16 border-t border-white/10">
      <div className="container px-6 md:px-12 max-w-[1400px] mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 md:gap-8 mb-24">
          <div className="md:col-span-4 space-y-8">
            ...
            <p className="text-[#C8D0E8] text-[13px] leading-relaxed max-w-xs font-normal">
            ...
            <div className="text-[13px] font-medium tracking-widest uppercase text-white">
              Hotline: <span className="text-[#FF6B47]">1900 1234</span>
            </div>
          </div>
          
          <div className="md:col-span-2 md:col-start-7">
            <h3 className="font-normal text-[11px] uppercase tracking-[0.15em] text-[#FF6B47] mb-6">Sản phẩm</h3>
            <ul className="space-y-4 text-[13px] text-[#C8D0E8] font-normal">
          ...
          <div className="md:col-span-2">
            <h3 className="font-normal text-[11px] uppercase tracking-[0.15em] text-[#FF6B47] mb-6">Công ty</h3>
            <ul className="space-y-4 text-[13px] text-[#C8D0E8] font-normal">
          ...
          <div className="md:col-span-2">
            <h3 className="font-normal text-[11px] uppercase tracking-[0.15em] text-[#FF6B47] mb-6">Pháp lý</h3>
            <ul className="space-y-4 text-[13px] text-[#C8D0E8] font-normal">
        ...
        <div className="pt-8 border-t border-white/10 flex flex-col md:flex-row justify-between items-center gap-4 text-[11px] text-[#C8D0E8] tracking-[0.15em] uppercase">
