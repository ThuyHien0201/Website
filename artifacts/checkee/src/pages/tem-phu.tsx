    ...
    <div className="flex flex-col w-full bg-[#0A1340]">
      <section className="relative h-[70vh] min-h-[600px] w-full overflow-hidden">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center px-6 text-center z-10 pt-20">
          <div className="text-[11px] uppercase tracking-[0.15em] text-[#FF6B47] mb-6">NĐ 37/2026 Khoản 2</div>
          <h1 className="text-4xl md:text-6xl text-white font-normal leading-[1.1] mb-6">
            Tôn vinh <span className="italic font-light text-[#FFFFFF]/80">bản gốc</span>
          </h1>
      ...
      <section className="py-32">
        <div className="container px-6 md:px-12 max-w-[1000px] mx-auto">
          <div className="mb-20">
            <div className="text-[11px] uppercase tracking-[0.15em] text-[#FF6B47] mb-4">Nghệ thuật phân phối</div>
            <h2 className="text-3xl font-normal text-white">
              Dấu ấn tinh tế. <span className="italic font-light text-[#C8D0E8]">Thông tin trọn vẹn.</span>
            </h2>
          </div>

          <div className="grid lg:grid-cols-2 gap-16 pt-12 hairline-t">
            <div className="space-y-6 opacity-50">
              <h3 className="text-[13px] text-[#C8D0E8] uppercase tracking-wide">Tem phụ giấy truyền thống</h3>
              <p className="font-normal leading-relaxed text-[13px] text-[#C8D0E8]">
