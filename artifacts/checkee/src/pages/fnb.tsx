    ...
    <div className="flex flex-col w-full bg-[#0A1340]">
      <section className="relative h-[70vh] min-h-[600px] w-full overflow-hidden">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center px-6 text-center z-10 pt-20">
          <div className="text-[11px] uppercase tracking-[0.15em] text-[#FF6B47] mb-6">Quyết định 1246/QĐ-BYT</div>
          <h1 className="text-4xl md:text-6xl text-white font-normal leading-[1.1] mb-6">
            Nghệ thuật <span className="italic font-light text-[#FFFFFF]/80">lưu mẫu</span>
          </h1>
        ...
        <div className="container px-6 md:px-12 max-w-[1000px] mx-auto">
          <div className="grid lg:grid-cols-2 gap-24">
            <div className="space-y-6">
              <div className="text-[11px] uppercase tracking-[0.15em] text-[#FF6B47]">Mặt Y Tế</div>
              <h3 className="text-2xl font-normal text-white">QR Hộp Lưu Mẫu</h3>
              <p className="text-[#C8D0E8] text-[13px] leading-relaxed">
            ...
            <div className="space-y-6">
              <div className="text-[11px] uppercase tracking-[0.15em] text-[#FF6B47]">Mặt Khách Hàng</div>
