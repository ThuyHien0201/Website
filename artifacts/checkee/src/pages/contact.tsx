    ...
    <div className="flex flex-col w-full bg-white font-sans">
      <section className="py-16 lg:py-24 bg-[#FAFBFC] border-b border-[#E5EAF0]">
        <div className="container max-w-[1280px] mx-auto px-6 lg:px-8 text-center">
          <h1 className="text-4xl lg:text-6xl font-bold text-[#1557B0] mb-6">Liên hệ tư vấn</h1>
        ...
        <div className="container max-w-[1280px] mx-auto px-6 lg:px-8">
          <div className="grid lg:grid-cols-12 gap-16 items-start">
                ...
                <form className="space-y-6" onSubmit={(e) => e.preventDefault()}>
                  <div className="grid md:grid-cols-2 gap-6">
                    <div className="space-y-2">
                      <Label className="text-[#1557B0] font-semibold">Họ và tên *</Label>
                      <Input placeholder="Nhập họ và tên..." className="bg-[#FAFBFC] border-[#E5EAF0]" />
                    </div>
                    <div className="space-y-2">
                      <Label className="text-[#1557B0] font-semibold">Email </Label>
                  ...
                  <div className="grid md:grid-cols-2 gap-6">
                    <div className="space-y-2">
                      <Label className="text-[#1557B0] font-semibold">Số điện thoại *</Label>
                      <Input type="tel" placeholder="Số điện thoại liên hệ..." className="bg-[#FAFBFC] border-[#E5EAF0]" />
                    </div>
                    <div className="space-y-2">
                      <Label className="text-[#1557B0] font-semibold">Tên doanh nghiệp</Label>
                      <Input placeholder="Công ty của bạn..." className="bg-[#FAFBFC] border-[#E5EAF0]" />
                    </div>
                  </div>
                  
                  <div className="space-y-2">
                    <Label className="text-[#1557B0] font-semibold">Sản phẩm quan tâm</Label>
                    <select className="flex h-9 w-full rounded-md border border-[#E5EAF0] bg-[#FAFBFC] px-3 py-1 text-base focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-[#1557B0] md:text-sm text-[#0F1B2D]">
                  ...
                  <div className="space-y-2">
                    <Label className="text-[#1557B0] font-semibold">Lời nhắn</Label>
            ...
            <div className="lg:col-span-5 space-y-6">
              <div className="bg-[#1557B0] rounded-2xl p-8 text-white shadow-lg">
                <div className="flex items-center gap-4 mb-4">
                  <div className="w-12 h-12 rounded-full bg-white/10 flex items-center justify-center">
                    <Phone className="w-6 h-6 text-[#DCEEFF]" />
                  </div>
                  <div>
                    <div className="text-[#DCEEFF] text-sm uppercase tracking-wider font-semibold mb-1">Hotline tư vấn</div>
              ...
              <div className="bg-white border border-[#E5EAF0] rounded-2xl p-8 flex items-start gap-4">
                <div className="w-12 h-12 rounded-full bg-[#DCEEFF] flex items-center justify-center shrink-0">
                  <Mail className="w-6 h-6 text-[#1557B0]" />
                </div>
                <div>
              ...
              <div className="bg-white border border-[#E5EAF0] rounded-2xl p-8 flex items-start gap-4">
                <div className="w-12 h-12 rounded-full bg-[#DCEEFF] flex items-center justify-center shrink-0">
                  <MapPin className="w-6 h-6 text-[#1557B0]" />
                </div>
                <div>
