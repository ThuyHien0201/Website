    ...
    <div className="flex flex-col w-full bg-[#0A1340]">
      ...
      <section className="relative h-[70vh] min-h-[600px] w-full overflow-hidden">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center px-6 text-center z-10 pt-20">
          <div className="text-[11px] uppercase tracking-[0.15em] text-[#FF6B47] mb-6">Thông tư 02/2024/TT-BKHCN</div>
          <h1 className="text-4xl md:text-6xl text-white font-normal leading-[1.1] mb-6">
            Sự minh bạch <span className="italic font-light text-[#FFFFFF]/80">tuyệt đối</span>
          </h1>
      ...
      <section className="py-32">
        <div className="container px-6 md:px-12 max-w-[1000px] mx-auto">
          <div className="mb-20">
            <div className="text-[11px] uppercase tracking-[0.15em] text-[#FF6B47] mb-4">10 Trường thông tin</div>
            <h2 className="text-3xl font-normal text-white">
              Chuẩn mực pháp lý. <span className="italic font-light text-[#C8D0E8]">Thiết kế nghệ thuật.</span>
            </h2>
          </div>
      ...
      {/* Up-sell Section */}
      <section className="py-32 bg-[#060C2A] text-center border-t border-white/5">
        <div className="container px-6 max-w-2xl mx-auto space-y-8">
          <h2 className="text-3xl font-normal text-white">Vươn ra <span className="italic font-light text-[#FF6B47]">thế giới</span></h2>
