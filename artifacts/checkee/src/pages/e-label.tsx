      ...
      <section className="py-12 bg-white">
        <div className="container max-w-[1280px] mx-auto px-6 lg:px-8">
          <div className="bg-[#EFF5FF] rounded-3xl p-8 lg:p-12 flex flex-col md:flex-row gap-8 items-center">
            ...
            <div>
              <h3 className="text-2xl font-bold text-[#1557B0] mb-3">Tuân thủ đầy đủ quy định pháp lý</h3>
      ...
      <section className="py-24 bg-[#FAFBFC]">
        <div className="container max-w-[1280px] mx-auto px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <h2 className="text-3xl lg:text-5xl font-bold text-[#1557B0] leading-tight">Tối ưu hóa quy trình in ấn</h2>
          </div>
      ...
      <section className="py-24 bg-white">
        <div className="container max-w-[1280px] mx-auto px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <h2 className="text-3xl lg:text-5xl font-bold text-[#1557B0] leading-tight">Vượt xa một chiếc nhãn</h2>
          </div>
