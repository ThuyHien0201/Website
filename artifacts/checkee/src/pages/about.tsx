  ...
  return (
    <div className="flex flex-col w-full bg-[#060B25]">
      <section className="relative h-[60vh] min-h-[500px] w-full overflow-hidden">
        ...
        <div className="absolute inset-0 bg-[#060B25]/70" />

        <div className="absolute inset-0 flex flex-col items-center justify-center px-6 text-center z-10 pt-20 max-w-3xl mx-auto">
          <div className="text-[11px] uppercase tracking-[0.15em] text-[#83776D] mb-6">Câu chuyện thương hiệu</div>
          <h1 className="text-4xl md:text-6xl text-white font-normal leading-[1.1] mb-6">
            Nghệ thuật <span className="italic font-light text-[#F5F5F0]/80">của sự thật</span>
          </h1>
          <p className="text-[15px] text-[#B8B5AE] leading-relaxed font-light italic">
      ...
      <section className="py-32">
        <div className="container px-6 md:px-12 max-w-2xl mx-auto space-y-24">
          ...
          <div className="border-l-2 border-[#83776D] pl-8 py-2">
          ...
          <div className="hairline-t pt-16 text-center">
            ...
            <Link href="/contact">
              <Button className="h-12 px-10 rounded-md bg-[#83776D] text-white tracking-[0.15em] uppercase text-[11px] hover:bg-[#83776D]/90 transition-all duration-300">
                Trở thành đối tác
              </Button>
            </Link>
          </div>
